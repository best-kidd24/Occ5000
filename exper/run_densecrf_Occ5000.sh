...
TEST_SET=val_unOcc500           #val, test
...
#######################################
SAVE_DIR=/mnt/data1/kidd/deeplab-v2/exper/${DATASET}/res/${FEATURE_NAME}/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}/post_densecrf_W${Bi_W}_XStd${Bi_X_STD}_RStd${Bi_R_STD}_PosW${POS_W}_PosXStd${POS_X_STD}
...
#if [ ${DATASET} == "voc12" ]
#then
#	IMG_DIR_NAME=pascal/VOCdevkit/VOC2012/VOCtrainval
#elif [ ${DATASET} == "coco" ]
#then
#    IMG_DIR_NAME=coco
...
IMG_DIR=/mnt/data1/kidd/deeplab-v2/data/Occ5000/PPMImages

if [ ${LOAD_MAT_FILE} == 1 ]
then
    # the features are saved in .mat format
    CRF_BIN=${CRF_DIR}/prog_refine_pascal_v4
    FEATURE_DIR=/mnt/data1/kidd/deeplab-v2/exper/${DATASET}/${FEATURE_NAME}/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}
else
