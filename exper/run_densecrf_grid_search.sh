...
#######################################
		    CRF_DIR=/mnt/data1/kidd/deeplab-v2/deeplab-public-ver2/densecrf
		    ...
		    IMG_DIR=/mnt/data1/kidd/deeplab-v2/data/${IMG_DIR_NAME}/VOCtrainval/PPMImages

		    # FEATURE_DIR saves the features for those "num_sample" images		    
		    FEATURE_DIR=/mnt/data1/kidd/deeplab-v2/exper/${DATASET}/features/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}/${FILE_NAME}_numSample${NUM_SAMPLE}
		    
		    SAVE_DIR=/mnt/data1/kidd/deeplab-v2/exper/${DATASET}/res/features/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}/post_densecrf_W${Bi_W}_XStd${Bi_X_STD}_RStd${Bi_R_STD}_PosW${POS_W}_PosXStd${POS_X_STD}_numSample${NUM_SAMPLE}
